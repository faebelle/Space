...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        # Filter the dataframe for the selected site and group by 'class'
...
def get_scatter_plot(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(
            ...
            color='Booster Version Category', title='Success by Payload for All States'
            )
    else: 
        ...
        fig = px.scatter(
            filtered_df, x='Payload Mass (kg)', y='class', 
                         ...
                         title=f'Success vs. Failed Launches for Payload Mass (kg){entered_site}')                        
    return fig
# Run the app
